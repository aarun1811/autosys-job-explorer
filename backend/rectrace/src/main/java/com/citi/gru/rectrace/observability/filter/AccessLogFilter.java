...
/**
 * OBS-01 — structured access log. Emits exactly one info-level event on the
 * {@code access} SLF4J logger per HTTP request, with MDC keys
 * {@code path / method / status / durationMs} populated alongside whatever
 * {@code traceId} and {@code userId} are already in MDC from
 * {@link com.citi.gru.rectrace.config.CorrelationIdPropagationConfig} (Phase 2)
 * and {@link UserIdMdcFilter}.
 *
