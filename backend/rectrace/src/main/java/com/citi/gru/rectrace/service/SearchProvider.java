...
import com.citi.gru.rectrace.dto.SearchCategoryDefinition; // Uses the full config DTO
import com.citi.gru.rectrace.dto.SearchCategoryResult;     // Returns the result DTO
