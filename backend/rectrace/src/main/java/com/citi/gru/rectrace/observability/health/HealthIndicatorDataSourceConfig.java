 ...
 *
 * <p>The shared primary {@link JdbcTemplate} (declared by Spring Boot + extended by
 * {@code LoaderJdbcConfig}) is consumed by V4 search code paths and the loader subsystem.
 * Mutating its {@code queryTimeout} via {@code setQueryTimeout(2)} would clamp every
