...
| **BOOT-03** | No `javax.*` imports remain (excluding JDK-namespace packages `javax.net.ssl`, `javax.crypto`, `javax.xml.*`) | — | N/A | grep | `! grep -rn '^import javax\.\(servlet\|persistence\|annotation\|sql\|transaction\|validation\|ws\|inject\)' backend/rectrace/src/main rectrace-tlm-stats/src/main` | ✅ |
