package com.citi.gru.rectrace.loader.observability;
...
/**
 * OBS-03 / D-7.3 — loader mirror of backend/rectrace's actuator security stub.
 *
 ...
 * (in {@code com.citi.gru.rectrace.loader.config}) is a single permissive
