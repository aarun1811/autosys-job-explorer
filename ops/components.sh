...
REGISTRY=(
  ...
  "loader|6089|run/loader.pid|logs/loader.log|http://localhost:6089/actuator/health/readiness|-|mvn spring-boot:run -f rectrace-loader/pom.xml -Dspring-boot.run.profiles=local"
